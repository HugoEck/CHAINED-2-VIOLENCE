...
public class Player2ComboManager : MonoBehaviour
{
    ...
    public void SetCombatWalkingSpeed()
    {
        ...
        _player2Attributes.movementSpeed = _player2Attributes.movementSpeed * 0.5f;
    }
    ...
    private void ApplyWeaponSlashEffect(int comboIndex)
    {
        if (currentAnimator.GetBool("WeaponSlash"))
        {
            if (currentPlayer2Weapon != null)
            {
                weaponSlashEffects[comboIndex].gameObject.transform.position = currentPlayer2Weapon.slashEffectPositions[comboIndex].position;
    ...
    private void PlayComboSound(int comboIndex)
    {
        ...
        if (currentPlayer2Weapon != null)
        {
            ...
            switch (currentEquippedPlayer2WeaponType)
            {
                ...
                default:
                    Debug.LogWarning($"No sound defined for weapon type: {currentEquippedPlayer2WeaponType}");
                    break;
            }
        }
