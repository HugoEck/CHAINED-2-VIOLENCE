...
public class WaveData : MonoBehaviour
{
    public void LoadWaves(List<Wave> waves)
    {
        ...
        waves.Add(CreateWave("Wave 2",
            new List<EnemyConfig>
            {
                new EnemyConfig { theme = NPC_Customization.NPCTheme.Roman, enemyClass = NPC_Customization.NPCClass.Basic, waveSize = 17 },
        ...
        waves.Add(CreateWave("Wave 15",
            new List<EnemyConfig>
            {
                ...
                new EnemyConfig { theme = NPC_Customization.NPCTheme.Indians, enemyClass = NPC_Customization.NPCClass.Basic, waveSize = 15 },
        ...
        waves.Add(CreateWave("Wave 16",
            new List<EnemyConfig>
            {
                ...
                new EnemyConfig { theme = NPC_Customization.NPCTheme.Indians, enemyClass = NPC_Customization.NPCClass.Warrior, waveSize = 10 }
            }
        ));
        waves.Add(CreateWave("Wave 17",
            new List<EnemyConfig>
            {
                ...
                new EnemyConfig { theme = NPC_Customization.NPCTheme.Cowboys, enemyClass = NPC_Customization.NPCClass.Warrior, waveSize = 10 },
                new EnemyConfig { theme = NPC_Customization.NPCTheme.Cowboys, enemyClass = NPC_Customization.NPCClass.Charger, waveSize = 1 },
                new EnemyConfig { theme = NPC_Customization.NPCTheme.Cowboys, enemyClass = NPC_Customization.NPCClass.Bannerman, waveSize = 1 },
        ...
        waves.Add(CreateWave("Wave 19",
            new List<EnemyConfig>
            {
                ...
                new EnemyConfig { theme = NPC_Customization.NPCTheme.Cowboys, enemyClass = NPC_Customization.NPCClass.Warrior, waveSize = 10 },
                new EnemyConfig { theme = NPC_Customization.NPCTheme.Cowboys, enemyClass = NPC_Customization.NPCClass.Charger, waveSize = 1 },
                new EnemyConfig { theme = NPC_Customization.NPCTheme.Indians, enemyClass = NPC_Customization.NPCClass.Basic, waveSize = 30 },
                new EnemyConfig { theme = NPC_Customization.NPCTheme.Indians, enemyClass = NPC_Customization.NPCClass.Warrior, waveSize = 10 },
                new EnemyConfig { theme = NPC_Customization.NPCTheme.Indians, enemyClass = NPC_Customization.NPCClass.Charger, waveSize = 1 }
            }
        ));
